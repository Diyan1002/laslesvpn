    ...
    <section className="bg-white py-16 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-[#0B132A] mb-4">Trusted by Thousands of <br /> Happy Customer</h2>
          <p className="text-lg text-[#4F5665] max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={testimonial.id}
              className={`bg-white border border-[#DDDDDD] rounded-2xl p-8 transition-all duration-300 ${
            ...
            >
              ...
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center">
                  ...
                  />
                  <div>
                    <h3 className="text-lg font-semibold text-[#0B132A]">{testimonial.name}</h3>
                    <p className="text-sm text-[#4F5665]">{testimonial.location}</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <span className="text-sm font-medium text-[#0B132A] mr-2">{testimonial.rating}</span>
                  <div className="flex">
                    {[...Array(5)].map((_, starIndex) => (
                      <svg
                        key={starIndex}
                        className={`w-4 h-4 ${starIndex < Math.floor(testimonial.rating) ? 'text-[#FEA250]' : 'text-[#DEDEDE]'}`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
              ...
              {/* Testimonial Text */}
              <p className="text-[#0B132A] text-base leading-relaxed">
                {testimonial.text}
              </p>
            </div>
          ))}
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-4">
            <button
              ...
              className="w-12 h-12 flex items-center justify-center border border-[#F53838] rounded-full text-[#F53838] hover:bg-[#F53838] hover:text-white transition-colors duration-300"
            >
